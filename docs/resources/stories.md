...
The [goal for designers](https://www.uxdesigninstitute.com/blog/5-elements-of-ux-design/) is to bring a positive experience to their end users, customers, or stakeholders.
...
There are [aspects to reusable UI](https://www.figma.com/resource-library/ui-design-principles/) such as consistent layout of information, intuitive interface for inputting and outputting data, and making an interface feel invisible to end users.  
...
When systems engineers use digital twins, most systems engineers model systems using a language called SysML or [Systems Modeling Language](https://en.wikipedia.org/wiki/Systems_modeling_language).  It a language built on top of UML or [Unified Modeling Language](https://en.wikipedia.org/wiki/Unified_Modeling_Language) which is used to model how a data within a database should be organized.  
...
A digital twin that has a [semantic reasoner](https://www.oxfordsemantic.tech/faqs/what-is-semantic-reasoning) or a knowledge based AI could have rules inputted into the system which will prevent or alert systems engineering if they are inputting requirements which violate the rules for a family van.  

The product I helped work on which was built with design based principles from its inception called [OML Vision](https://github.com/opencaesar/oml-vision) allowed systems engineers to intuitively create digital twins while allowing them to run a knowledge based AI on their requirements.  Use cases of the product are at NASA JPL and JAXA.
